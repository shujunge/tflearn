...
model = tflearn.DNN(regression, checkpoint_path='./weight/model.tfl.ckpt')
...
# Manually save model
model.save("./weight/model.tfl")

# Load a model
model.load("./weight/model.tfl")

#show the frist image
# import matplotlib.pyplot as plt
# import numpy as np
# print(testX[:1].shape)
# im=testX[:1].reshape(28,28)
# print(im.shape)
# plt.imshow(im,cmap = plt.cm.gray)
# plt.show()

##predict the result
# print(model.predict(testX[:1]).shape)
# print(model.predict(testX[:1]))
# print(model.predict_label(testX[:1]))
# print(testY[0:1])
# exit()
